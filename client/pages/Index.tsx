        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              कॉफी और चाय संग्रह (Coffee & Tea Collection)
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Explore our exquisite selection of premium coffees and specialty teas,
              from traditional Indian chai to international favorites, all crafted with expertise and passion.
            </p>
          </div>
